...
function [Fig7_ctrl_MLA Fig7_aPN2_aPN3 Fig7_aPN2aPN3_B1 Fig7_tnt_ss Fig7_tnt_onset Fig7_chrimson_APN2 Fig7_chrimson_APN3 ...
    Fig7_chrimson_sub2 Fig7_chrimson_sub3 Fig7_chrimsonQuant Fig7_APN2APN3_ipsiContra Fig7_B1_ipsiContra Fig7_APN2_B1_TNT ...
    Fig7_chrimson_B1 Fig7_chrimson_sub4 Fig7_chrimson_addTraces Fig7_tnt_ipsiContraRem_ss Fig7_tnt_ipsiContraRem_mag] ...
    = MakeFigure7(ERROR_AVG_VM_TRACES, TRACE_TYPE, TITLES)
...
trace2.name = ['+MLA'];
Fig7_ctrl_MLA = MakeTracePairFigure(trace1, trace2, ERROR_AVG_VM_TRACES, tracesPos_TNT1, SPIKERATE);
...
Fig7_aPN2_aPN3 = MakeTracePairFigure(trace1, trace2, ERROR_AVG_VM_TRACES, tracesPos_TNT2, SPIKERATE);
...
trace2.name = ['B1>TNT'];
Fig7_aPN2aPN3_B1 = MakeTracePairFigure(trace1, trace2, ERROR_AVG_VM_TRACES, tracesPos_TNT3, SPIKERATE);
...
Fig7_APN2APN3_ipsiContra = MakeTracePairFigure(trace1, trace2, ERROR_AVG_VM_TRACES, tracesPos_TNT4, SPIKERATE);
...
Fig7_B1_ipsiContra = MakeTracePairFigure(trace1, trace2, ERROR_AVG_VM_TRACES, tracesPos_TNT1, SPIKERATE);
...
Fig7_APN2_B1_TNT = MakeTracePairFigure(trace1, trace2, ERROR_AVG_VM_TRACES, tracesPos_TNT2, SPIKERATE);
...
TEST = 0;
Fig7_tnt_ss = MakeIpsiContraPlot(all_traces, ONSET, TEST, diffFigPosition2, yAxis_ipsiContra_TNT, testPairs, starLevels);
%onset comparison
Fig7_tnt_onset = MakeIpsiContraPlot(all_traces, 1, TEST, diffFigPosition2, yAxis_ipsiContra_TNT, testPairs, starLevels);
...
%steady state comparison
Fig7_tnt_ipsiContraRem_ss = MakeIpsiContraPlot(all_traces, 0, TEST, diffFigPosition2, yAxis_ipsiContra_TNT, testPairs, starLevels); %steady state

Fig7_tnt_ipsiContraRem_mag = MakeIpsiContraPlot(all_traces, 2, TEST, diffFigPosition2, yAxis_ipsiContra_TNT, testPairs, starLevels); %steady state
...
traces2 = {}; names2 = '';
Fig7_chrimson_APN2 = MakeChrimsonPlots(traces1,names1, traces2, names2, ERROR_AVG_VM_TRACES, tracesPositionActivation, SPIKERATE);
...
Fig7_chrimson_APN3 = MakeChrimsonPlots(traces1,names1, traces2, names2, ERROR_AVG_VM_TRACES, tracesPositionActivation, SPIKERATE);
...
Fig7_chrimson_B1 = MakeChrimsonPlots(traces1,names1, traces2, names2, ERROR_AVG_VM_TRACES, tracesPositionActivation, SPIKERATE);
...
names2 = {['APN2-MLA']};
Fig7_chrimson_sub2 = MakeChrimsonPlots(traces1, names1, traces2, names2, ERROR_AVG_VM_TRACES, tracesPositionActivation, SPIKERATE);
...
names2 = {['APN3-MLA']};
Fig7_chrimson_sub3 = MakeChrimsonPlots(traces1, names1, traces2, names2, ERROR_AVG_VM_TRACES, tracesPositionActivation, SPIKERATE);
...
traces2{1} = tracesAPN3minMLA;
names2 = {['WILL BE B1-MLA']};
Fig7_chrimson_sub4 = MakeChrimsonPlots(traces1, names1, traces2, names2, ERROR_AVG_VM_TRACES, tracesPositionActivation, SPIKERATE);
...
traces2{1} = tt;
Fig7_chrimson_addTraces = MakeChrimsonPlots(traces, {'APN2+B1'}, traces2, {'B1-APN2'}, ERROR_AVG_VM_TRACES, tracesPositionActivation, SPIKERATE);
...
Fig7_chrimsonQuant = MakeChrimsonQuantificationPlot(traces, traceNames, xLocs, positionChrimsonQuant, testPairs, starLevels);
